...
public class CameraMovement : MonoBehaviour
{
  ...
  public void LateUpdate()
  {
    ...
    if ((double) num1 == 0.0 && hardManager.IsUsingController() && (hardInput.GetKeyDown("ZoomIn") || hardInput.GetKeyDown("ZoomOut")))
      num1 = hardInput.GetKey("Extended Shot") ? 1f : -1f;
    ...
    if ((MyInput.GetMouseButton(1) || MyInput.GetMouseButton(2) || Input.touchCount == 1 && !Player.IsPointerOverGameObject(0) && (Object) Player.Instance?.selectedSpell == (Object) null) && (!HUD.UseTouchControls || (double) Input.GetAxis("Mouse X") != 0.0 || (double) Input.GetAxis("Mouse Y") != 0.0))
    {
      this.KillMovement();
