...
namespace Educative
{
  ...
  {
    public List<TournamentBracket.Participant> playersList = new List<TournamentBracket.Participant>();
    ...
    public TournamentBracket(Tournament t)
    {
    }
    ...
    public TournamentBracket(List<string> p, bool randomSeeds)
    {
      ...
      {
        this.playersList.Add(new TournamentBracket.Participant()
        {
          name = str,
          seed = num
        });
      ...
      {
        for (int index2 = 0; index2 < this.playersList.Count; ++index2)
        {
          int index3 = Server.random.Next(0, this.playersList.Count);
          if (index3 != index2)
          {
            TournamentBracket.Participant players = this.playersList[index2];
            this.playersList[index2] = this.playersList[index3];
            this.playersList[index3] = players;
          }
        }
      }
