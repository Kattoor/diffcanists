...
public static class Prefs
{
  ...
  public static int mapEditorWidthX
  {
    get
    {
      return Prefs.GetInt(nameof (mapEditorWidthX), 1920);
    }
    set
    {
      Prefs.SetInt(nameof (mapEditorWidthX), value);
    }
  }
  ...
  public static int mapEditorWidthY
  {
    get
    {
      return Prefs.GetInt(nameof (mapEditorWidthY), 960);
    }
    set
    {
      Prefs.SetInt(nameof (mapEditorWidthY), value);
    }
  }
