    ...
    for (int index1 = Math.Min(Math.Min((int) vector3_1.y, (int) vector3_2.y), Math.Min((int) vector3_3.y, (int) vector3_4.y)); index1 < num7; ++index1)
    {
      for (int index2 = num6; index2 < num5; ++index2)
      {
        ...
        if (num10 >= 0.0 && num10 < (double) width && (num12 >= 0.0 && num12 < (double) height))
        {
          ...
          Color32 color32_2 = src.get_Item(x1, y1);
          Color32 color32_3 = src.get_Item(x2, y1);
          Color32 color32_4 = src.get_Item(x1, y2);
          Color32 color32_5 = src.get_Item(x2, y2);
          double num17 = (double) color32_2.r * num14 + (double) color32_3.r * num13;
          double num18 = (double) color32_4.r * num14 + (double) color32_5.r * num13;
          color32_1.r = (byte) (num17 * num16 + num18 * num15);
          double num19 = (double) color32_2.g * num14 + (double) color32_3.g * num13;
          double num20 = (double) color32_4.g * num14 + (double) color32_5.g * num13;
          color32_1.g = (byte) (num19 * num16 + num20 * num15);
          double num21 = (double) color32_2.b * num14 + (double) color32_3.b * num13;
          double num22 = (double) color32_4.b * num14 + (double) color32_5.b * num13;
          color32_1.b = (byte) (num21 * num16 + num22 * num15);
          double num23 = (double) color32_2.a * num14 + (double) color32_3.a * num13;
          double num24 = (double) color32_4.a * num14 + (double) color32_5.a * num13;
          color32_1.a = (byte) (num23 * num16 + num24 * num15);
          color32_1.a = color32_1.a >= (byte) 150 ? byte.MaxValue : (byte) 0;
          if (infront || dst.GetPixel(index2 + x - num1, index1 + y).a == (byte) 0)
          {
            Color32 p = (Color32) ColorHSV.AdjustColor((Color) color32_1, h);
    ...
    for (int index1 = Math.Min(Math.Min((int) vector3_1.y, (int) vector3_2.y), Math.Min((int) vector3_3.y, (int) vector3_4.y)); index1 < num7; ++index1)
    {
      for (int index2 = num6; index2 < num5; ++index2)
      {
        ...
        if (num10 >= 0.0 && num10 < (double) width && (num12 >= 0.0 && num12 < (double) height))
        {
          ...
          if (infront || dst.get_Item(index2 + x - num1, index1 + y).a == (byte) 0)
          {
            Color32 c = (Color32) ColorHSV.AdjustColor((Color) color32_1, h, saturation);
            dst.set_Item(index2 + x - num1, index1 + y, c);
          }
        }
      }
    ...
    for (int index1 = num8; index1 < num7; ++index1)
    {
      for (int index2 = num6; index2 < num5; ++index2)
      {
        ...
        if (num12 >= 0.0 && num12 < (double) width && (num14 >= 0.0 && num14 < (double) height))
        {
          ...
          double num20 = 1.0 - num19;
          Color32 color32_1 = new Color32();
          Color32 color32_2 = src.get_Item(num9 - num15, y1);
          Color32 color32_3 = src.get_Item(num9 - num16, y1);
          Color32 color32_4 = src.get_Item(num9 - num15, y2);
          Color32 color32_5 = src.get_Item(num9 - num16, y2);
          double num21 = (double) color32_2.r * num18 + (double) color32_3.r * num17;
          double num22 = (double) color32_4.r * num18 + (double) color32_5.r * num17;
          color32_1.r = (byte) (num21 * num20 + num22 * num19);
          double num23 = (double) color32_2.g * num18 + (double) color32_3.g * num17;
          double num24 = (double) color32_4.g * num18 + (double) color32_5.g * num17;
          color32_1.g = (byte) (num23 * num20 + num24 * num19);
          double num25 = (double) color32_2.b * num18 + (double) color32_3.b * num17;
          double num26 = (double) color32_4.b * num18 + (double) color32_5.b * num17;
          color32_1.b = (byte) (num25 * num20 + num26 * num19);
          double num27 = (double) color32_2.a * num18 + (double) color32_3.a * num17;
          double num28 = (double) color32_4.a * num18 + (double) color32_5.a * num17;
          color32_1.a = (byte) (num27 * num20 + num28 * num19);
          color32_1.a = color32_1.a >= (byte) 150 ? byte.MaxValue : (byte) 0;
          if (infront || dst.get_Item(index2 + x - num1, index1 + y).a == (byte) 0)
          {
            Color32 c = (Color32) ColorHSV.AdjustColor((Color) color32_1, h, saturation);
