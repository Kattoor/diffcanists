...
public class ZEffector : ZComponent
{
  ...
  public virtual void Die(int indexInParent, bool destroyable, bool global)
  {
    ...
    if (this.type == EffectorType.Tombstone && this.turnsAlive >= this.MaxTurnsAlive && ((ZComponent) this.whoSummoned != (object) null && !this.whoSummoned.isDead) && (this.whoSummoned.familiarLevelNecromancy >= 3 && this.whoSummoned.CanMakeZombie()))
      ZSpell.FireSummon(Inert.GetSpell(SpellEnum.Summon_Zombie), this.game, this.whoSummoned, this.position, 1, false, (ZPerson) null);
      ...
      if (!this.active || this.type == EffectorType.Prickly_Barrier || (this.type == EffectorType.Storm_Shield || this.type == EffectorType.Troll) && this.variable > 0)
      {
        ...
        switch (this.type)
        {
          ...
          case EffectorType.Conductor_Rod:
            ...
            this.game.ongoing.RunSpell(ZSpell.IEnumeratorConductorRod(this.whoSummoned, pos1, -30, 30, amount, true, (int) pos1.x, y1, this.spell.parent), true);
            this.active = false;
            if (this.turnsAlive != 2)
              break;
            this.Die(indexInParent, destroyable, global);
          ...
          case EffectorType.Sand_Mite_Embeded:
            ...
            for (int index = 0; index < 5; ++index)
            {
              if ((ZComponent) this.whoSummoned != (object) null && !this.whoSummoned.isDead)
                this.whoSummoned.ApplyDamage(SpellEnum.Summon_Sand_Mite, DamageType.None, 1, this.whoSummoned, this.TurnCreated, (ISpellBridge) Inert.GetSpell("Summon Sand Mite"), false);
            }
            break;
          ...
          case EffectorType.Flight:
            ...
            {
              this.whoSummoned.RemoveFlight(false, false);
              this.Die(indexInParent, destroyable, global);
              break;
            }
            this.active = false;
  ...
  public static void CheckSanctuary(ZMyWorld world, ZCreature c)
  {
    ...
    if (!((ZComponent) zmyWorld.FindColliderAtPoint(x, y, 32768) != (object) null))
      return;
    ZEffector.EffectSanctuary(c.game, c, false);
  }
    ...
    for (int index = 0; index < zmyColliderList.Count; ++index)
    {
      if (zmyColliderList[index].gameObjectLayer == 13)
      {
        ...
        if ((ZComponent) tower != (object) null && (force || ZEffector.InSanctuary(tower.creature.game.world, tower.creature.position)))
          ZEffector.EffectSanctuary(tower.creature.game, tower.creature, false);
      }
      else if (zmyColliderList[index].gameObjectLayer == 8 || zmyColliderList[index].gameObjectLayer == 16)
      {
        ...
        if (!ZComponent.IsNull((ZComponent) creature) && (force || ZEffector.InSanctuary(creature.game.world, creature.position)))
          ZEffector.EffectSanctuary(creature.game, creature, false);
      }
      else
      {
    ...
    switch (this.type)
    {
          ...
          else
          {
            ...
            if ((ZComponent) creature != (object) null && (creature.race != CreatureRace.Effector || creature.GetType() == typeof (ZCreatureTree)))
            {
              ...
              if (flag && (creature.race != CreatureRace.Effector || creature.type == CreatureType.Tree))
              {
                ...
                if (ZComponent.IsNull((ZComponent) zcreature2))
                  zcreature2 = this.map.PhysicsCollideCreature(creature, (int) creature.position.x - 5, (int) creature.position.y - creature.radius - 10, 0);
                if (creature.radius > 50 && ZComponent.IsNull((ZComponent) zcreature2))
                  zcreature2 = this.map.PhysicsCollideCreature(creature, (int) creature.position.x - 10, (int) creature.position.y - creature.radius - 10, 0);
                if (creature.radius > 50 && ZComponent.IsNull((ZComponent) zcreature2))
                  zcreature2 = this.map.PhysicsCollideCreature(creature, (int) creature.position.x + 10, (int) creature.position.y - creature.radius - 10, 0);
                if (creature.radius > 90 && ZComponent.IsNull((ZComponent) zcreature2))
                  zcreature2 = this.map.PhysicsCollideCreature(creature, (int) creature.position.x + 15, (int) creature.position.y - creature.radius - 10, 0);
                if (creature.radius > 90 && ZComponent.IsNull((ZComponent) zcreature2))
                  zcreature2 = this.map.PhysicsCollideCreature(creature, (int) creature.position.x + 20, (int) creature.position.y - creature.radius - 10, 0);
                if (creature.radius > 90 && ZComponent.IsNull((ZComponent) zcreature2))
                  zcreature2 = this.map.PhysicsCollideCreature(creature, (int) creature.position.x + 25, (int) creature.position.y - creature.radius - 10, 0);
                if (creature.radius > 90 && ZComponent.IsNull((ZComponent) zcreature2))
                  zcreature2 = this.map.PhysicsCollideCreature(creature, (int) creature.position.x + 30, (int) creature.position.y - creature.radius - 10, 0);
                if (this.damageType.IsDeath() && (ZComponent) zcreature2 != (object) null && ((ZComponent) zcreature2 != (object) this.whoSummoned || this.type == EffectorType.Aura_of_decay) && ((ZComponent.IsNull((ZComponent) zcreature2.tower) || zcreature2.tower.type != TowerType.Nature) && (zcreature2.race != CreatureRace.Effector || zcreature2.GetType() == typeof (ZCreatureTree))) && (this.damageType != DamageType.Infection && zcreature2.type != CreatureType.Dryad) && ((this.damageType != DamageType.Arcane || (ZComponent) this.whoSummoned != (object) zcreature2 || (ZComponent) zcreature2.tower != (object) null && zcreature2.tower.type == TowerType.Arcane || (zcreature2.FullArcane || zcreature2.type == CreatureType.Imp || zcreature2.type == CreatureType.Egg)) && zcreature2.type != CreatureType.Dryad))
                {
      ...
      case EffectorType.Sacrifical_Altar_Aura:
        ...
        for (int index = 0; index < zmyColliderList2.Count; ++index)
        {
          if (zmyColliderList2[index].gameObjectLayer == 13)
          {
            ...
            if ((ZComponent) tower != (object) null && ((ZComponent) tower.creature != (object) this.whoSummoned || this.damageType == DamageType.Infection) && tower.type != TowerType.Nature)
            {
              ...
              ZCreature zcreature2 = this.map.PhysicsCollideCreature(tower.creature, (int) tower.position.x, (int) tower.position.y - 25, 0);
              if (this.damageType.IsDeath() && (ZComponent) zcreature2 != (object) null && ((ZComponent) zcreature2 != (object) this.whoSummoned || this.damageType == DamageType.Infection) && ((ZComponent.IsNull((ZComponent) zcreature2.tower) || zcreature2.tower.type != TowerType.Nature) && (zcreature2.race != CreatureRace.Effector || zcreature2.GetType() == typeof (ZCreatureTree))) && this.damageType != DamageType.Infection)
          ...
          else
          {
            ...
            if ((ZComponent) creature != (object) null && ((ZComponent) creature != (object) this.whoSummoned || this.damageType == DamageType.Infection || this.type == EffectorType.Sacrifical_Altar_Aura) && ((creature.race != CreatureRace.Effector || creature.GetType() == typeof (ZCreatureTree)) && creature.type != CreatureType.Dryad) && (!this.damageType.IsSting() || creature.race == CreatureRace.Undead && this.damageType != DamageType.StingUndead || creature.race != CreatureRace.Undead && this.damageType == DamageType.StingUndead || creature.type != CreatureType.Bee && creature.type != CreatureType.Beehive && ((ZComponent) creature.rider == (object) null || creature.rider.type != CreatureType.Beehive || (ZComponent) this.whoSummoned == (object) creature.rider) || creature.parent.team != this.whoSummoned.parent.team))
            {
              ...
              if (creature.race != CreatureRace.Effector || creature.type == CreatureType.Tree)
              {
                ...
                if (creature.radius > 90 && ZComponent.IsNull((ZComponent) zcreature2))
                  zcreature2 = this.map.PhysicsCollideCreature(creature, (int) creature.position.x + 30, (int) creature.position.y - creature.radius - 10, 0);
                if (this.damageType.IsDeath() && (ZComponent) zcreature2 != (object) null && ((ZComponent) zcreature2 != (object) this.whoSummoned || this.damageType == DamageType.Infection) && ((ZComponent.IsNull((ZComponent) zcreature2.tower) || zcreature2.tower.type != TowerType.Nature) && (zcreature2.race != CreatureRace.Effector || zcreature2.GetType() == typeof (ZCreatureTree))) && (this.damageType != DamageType.Infection && creature.type != CreatureType.Dryad))
                {
                  if ((ZComponent) zcreature2.rider != (object) null && (ZComponent) creature != (object) zcreature2.rider)
                  {
                    zcreatureList2.Add(zcreature2);
        ...
        foreach (ZCreature c1 in zcreatureList2)
        {
          if ((ZComponent) c1 != (object) null && c1.health > 0)
          {
            c1.ApplyDamage(lichAuraSpell.spellEnum, this.damageType, lichAuraSpell.damage, this.GetInfector, this.TurnCreated, (ISpellBridge) lichAuraSpell, false);
            if (this.damageType == DamageType.Infection)
      ...
      case EffectorType.Soul_Jar:
        break;
      case EffectorType.Sanctuary:
        ZEffector.EffectSanctuary(this.game, c, false);
        break;
      case EffectorType.Troll:
        if (!((ZComponent) c != (object) null) || !((ZComponent) c != (object) this.whoSummoned) || c.race == CreatureRace.Effector && c.type != CreatureType.Tree)
          break;
        int variable = this.variable;
        if ((ZComponent) this.whoSummoned != (object) null && c.parent.team == this.whoSummoned.parent.team && this.whoSummoned.familiarLevelSeas > 0)
          break;
        this.active = false;
      ...
      case EffectorType.Life_Dew:
        ...
        if (!ZComponent.IsNull((ZComponent) this.whoSummoned))
        {
          ...
          if (team1.GetValueOrDefault() == team2.GetValueOrDefault() & team1.HasValue == team2.HasValue)
          {
            if (c.type == CreatureType.Bee && c.race != CreatureRace.Undead)
            {
              this.active = true;
              if (this.variable < 30)
                this.variable += 15;
...
label_59:
      ...
      case EffectorType.AutumnLeaves:
        ...
        if ((ZComponent) this.whoSummoned != (object) null)
        {
          int? team1 = c.parent?.team;
          int? team2 = this.whoSummoned.parent?.team;
          num2 = !(team1.GetValueOrDefault() == team2.GetValueOrDefault() & team1.HasValue == team2.HasValue) ? 1 : 0;
        }
        else
          num2 = 1;
        if (num2 == 0)
  ...
  public IEnumerator<float> IEVolcano()
  {
    ...
    if (!zeffector.dead && !ZComponent.IsNull((ZComponent) zeffector))
    {
      ...
      else if (zeffector.turnsAlive == 5)
      {
        ...
        int index = zeffector.whoSummoned.effectors.FindIndex(new Predicate<ZEffector>(zeffector.\u003CIEVolcano\u003Eb__125_0));
  ...
  public IEnumerator<float> IESupernova()
  {
    ...
    if (!zeffector.dead && !ZComponent.IsNull((ZComponent) zeffector))
    {
      ...
      else if (zeffector.turnsAlive == 5)
      {
        ...
        int index = zeffector.whoSummoned.effectors.FindIndex(new Predicate<ZEffector>(zeffector.\u003CIESupernova\u003Eb__126_0));
        zeffector.Die(index, false, false);
      }
    }
  }
  ...
  public IEnumerator<float> IEShootingStars()
  {
    ...
    if (!zeffector.dead && !ZComponent.IsNull((ZComponent) zeffector))
    {
      ...
      else
      {
        ...
        yield return 0.0f;
        zeffector.FireShootingStar(spell, 3);
        int index = zeffector.whoSummoned.effectors.FindIndex(new Predicate<ZEffector>(zeffector.\u003CIEShootingStars\u003Eb__128_0));
        zeffector.Die(index, false, false);
      }
    }
  }
  ...
  public IEnumerator<float> IESandyShores()
  {
    ...
    if (!zeffector.dead && !ZComponent.IsNull((ZComponent) zeffector))
    {
      ...
      else if (zeffector.turnsAlive == 2 || zeffector.turnsAlive == 3)
      {
        ...
        {
          int index = zeffector.whoSummoned.effectors.FindIndex(new Predicate<ZEffector>(zeffector.\u003CIESandyShores\u003Eb__129_0));
          zeffector.Die(index, false, false);
        }
      }
    }
  ...
  public IEnumerator<float> IEMaelStrom()
  {
    ...
    if (!zeffector.dead && !ZComponent.IsNull((ZComponent) zeffector))
    {
      ...
      else if (zeffector.turnsAlive == 2 || zeffector.turnsAlive == 3)
      {
        ...
        if (zeffector.turnsAlive == 3)
        {
          int index = zeffector.whoSummoned.effectors.FindIndex(new Predicate<ZEffector>(zeffector.\u003CIEMaelStrom\u003Eb__130_0));
          zeffector.Die(index, false, false);
        }
      }
    }
